...
public class MachineLaverActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_machine_laver);
        recyclerView = findViewById(R.id.recycler_view_machine);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(MachineLaverActivity.this));
    ...
    public class JsonFetch extends AsyncTask<String, Integer, String> {
        ...
        protected String doInBackground(String... strings) {
            try {
                URL url = new URL("https://astelmobile.000webhostapp.com/ServicesAstel/laver.php");
        ...
        protected void onPostExecute(String s) {
            ...
            MachineAdapter homeAdapter = new  MachineAdapter(mMyData,MachineLaverActivity.this);
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(MachineLaverActivity.this);
