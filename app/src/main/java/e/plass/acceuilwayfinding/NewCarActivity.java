...
import e.plass.acceuilwayfinding.model.NewCarAdapter;
...
public class NewCarActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.recycler_view_new_car);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(NewCarActivity.this));
    ...
    public class JsonFetch extends AsyncTask<String, Integer, String> {
        ...
        protected String doInBackground(String... strings) {
            try {
                URL url = new URL("https://astelmobile.000webhostapp.com/ServicesAstel/neuve.php");
        ...
        protected void onPostExecute(String s) {
            ...
            NewCarAdapter homeAdapter = new NewCarAdapter(mMyData,NewCarActivity.this);
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(NewCarActivity.this);
