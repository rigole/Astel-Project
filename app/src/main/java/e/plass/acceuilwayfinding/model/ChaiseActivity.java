...
public class ChaiseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chaise);
        recyclerView = findViewById(R.id.recycler_view_chaise);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(ChaiseActivity.this));
    ...
    public class JsonFetch extends AsyncTask<String, Integer, String> {
        ...
        protected String doInBackground(String... strings) {
            try {
                URL url = new URL("https://astelmobile.000webhostapp.com/ServicesAstel/chairoffice.php");
        ...
        protected void onPostExecute(String s) {
            ...
            ChaiseAdapter homeAdapter = new  ChaiseAdapter(mMyData,ChaiseActivity.this);
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(ChaiseActivity.this);
