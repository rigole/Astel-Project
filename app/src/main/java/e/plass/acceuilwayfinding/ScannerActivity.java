...
import e.plass.acceuilwayfinding.model.ScannerAdapter;
...
public class ScannerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.recycler_view_scanner);
    ...
    public class JsonFetch extends AsyncTask<String, Integer, String> {
        ...
        protected String doInBackground(String... strings) {
            try {
                URL url = new URL("https://astelmobile.000webhostapp.com/ServicesAstel/scan.php");
        ...
        protected void onPostExecute(String s) {
           ...
           ScannerAdapter homeAdapter = new ScannerAdapter(mMyData,ScannerActivity.this);
