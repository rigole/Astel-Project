...
import e.plass.acceuilwayfinding.model.TableAdapter;
...
public class TableActivity extends AppCompatActivity {
    ...
    public class JsonFetch extends AsyncTask<String, Integer, String> {
        ...
        protected String doInBackground(String... strings) {
            try {
                URL url = new URL("https://astelmobile.000webhostapp.com/ServicesAstel/table.php");
        ...
        protected void onPostExecute(String s) {
            ...
            TableAdapter homeAdapter = new   TableAdapter(mMyData,TableActivity.this);
