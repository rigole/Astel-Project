...
import e.plass.acceuilwayfinding.model.MeubleAdapter;

public class MeubleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.recycler_view_meuble);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(MeubleActivity.this));
    ...
    public class JsonFetch extends AsyncTask<String, Integer, String> {
        ...
        protected String doInBackground(String... strings) {
            try {
                URL url = new URL("https://astelmobile.000webhostapp.com/ServicesAstel/meuble.php");
        ...
        protected void onPostExecute(String s) {
          ...
          MeubleAdapter homeAdapter = new MeubleAdapter(mMyData,MeubleActivity.this);
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(MeubleActivity.this);
