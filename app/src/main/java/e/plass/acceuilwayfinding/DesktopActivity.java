...
import e.plass.acceuilwayfinding.model.DesktopAdapter;
...
public class DesktopActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.recycler_view_desktop);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(DesktopActivity.this));
        ...
        levee.setOnClickListener(v -> {
            Intent intent = new Intent(DesktopActivity.this, LeveeDeFondActivity.class);
    ...
    public class JsonFetch extends AsyncTask<String, Integer, String> {
        ...
        protected String doInBackground(String... strings) {
            try {
                URL url = new URL("https://astelmobile.000webhostapp.com/ServicesAstel/desktop.php");
        ...
        protected void onPostExecute(String s) {
            ...
            DesktopAdapter homeAdapter = new  DesktopAdapter(mMyData,DesktopActivity.this);
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(DesktopActivity.this);
