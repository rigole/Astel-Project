...
import e.plass.acceuilwayfinding.model.PickupAdapter;
...
public class PickupActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.recycler_view_pick);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(PickupActivity.this));
    ...
    public class JsonFetch extends AsyncTask<String, Integer, String> {
        ...
        protected String doInBackground(String... strings) {
            try {
                URL url = new URL("https://astelmobile.000webhostapp.com/ServicesAstel/pick.php");
        ...
        protected void onPostExecute(String s) {
            ...
            PickupAdapter homeAdapter = new   PickupAdapter(mMyData,PickupActivity.this);
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(PickupActivity.this);
